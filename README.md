...
5. Use script to check the infinte combinations in a Moxfield deck list.
    ...
    3. Example:
        1. `./comboParser.py --commanderSpellbookFiles specific/* recent/* comboFiles/* --moxfieldTextfile cabal-a-faster-krrik-storm--cedh-w-primer-20260808-031552.txt`
...
6. Use script to find cards that might be good for your current card combinations through the threshold argument.  It prints the 
    1. Example
        1. `./comboParser.py --commanderSpellbookFiles specific/* recent/* comboFiles/* --manaboxCsvfile ManaBox_Collection.csv --threshold 1 | tail`
    ...
    4. A better way of viewing it is to look at those combinations
       1. `./comboParser.py --commanderSpellbookFiles specific/* recent/* comboFiles/* --manaboxCsvfile ManaBox_Collection.csv --threshold 1 | grep Kodama | sort`
